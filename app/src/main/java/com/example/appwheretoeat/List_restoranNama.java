...
public class List_restoranNama extends ListActivity {
String ip="",myPosisi,myLati,myLongi;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_listcari);
		...
		Button	btncari= (Button) findViewById(R.id.btncari);btncari.setText("Cari Item");
	...
	//	new load().execute();
        ...
        bottomNavigationView.setSelectedItemId(R.id.carinama);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_restoranNama.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_restoranNama.this, arrayList,R.layout.desain_list, new String[] { TAG_id_restoran,TAG_nama_restoran, TAG_budget,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
