...
public class Detail_pelanggan extends Activity {
	String ip="";
	String id_pelanggan;
	String id_pelanggan0="";
	
	EditText txtid_pelanggan;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detail_pelanggan);
		
		ip=jsonParser.getIP();
		callMarquee();
		
		txtid_pelanggan = (EditText) findViewById(R.id.txtid_pelanggan);
		...
		Intent p = getIntent();
		id_pelanggan0 = p.getStringExtra("pk");
		...
		btnProses.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				id_pelanggan= txtid_pelanggan.getText().toString();
				...
				if(id_pelanggan.length()<1){lengkapi("id_pelanggan");}
				else if(lnama_pelanggan.length()<1){lengkapi("nama_pelanggan");}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
	class get extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Detail_pelanggan.this);
		...
		protected String doInBackground(String... params) {
					...
					try {
						...
						if (sukses == 1) {
							...
							public void run() {	
								try {
										txtid_pelanggan.setText(id_pelanggan0);
	...
	class save extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			String lstatuss= txtstatuss.getText().toString();
				...
				params.add(new BasicNameValuePair("id_pelanggan0", id_pelanggan0));
